...
import static com.reprezen.kaizen.normalizer.Option.OptionType.HOIST;
import static com.reprezen.kaizen.normalizer.Option.OptionType.INLINE;
import static com.reprezen.kaizen.normalizer.Option.OptionType.RETAIN;
import static com.reprezen.kaizen.normalizer.Option.OptionType.RETENTION_SCOPE;
...
public class Option {
	...
	public static final Set<Component> ALL_OBJECTS = ImmutableSet.of( //
			V2State.PATH, //
			V2State.SCHEMA, //
			V2State.PARAMETER, //
			V2State.RESPONSE, //
			...
			V3State.RESPONSE, //
			V3State.EXAMPLE, //
			V3State.REQUEST_BODY, //
			V3State.HEADER, //
			V3State.SECURITY_SCHEME, //
			V3State.LINK, //
			V3State.CALLBACK);

	public static final Set<Component> COMPONENT_OBJECTS = ImmutableSet.of( //
			V2State.SCHEMA, //
			V2State.PARAMETER, //
			V2State.RESPONSE, //
	...
	public static final Set<Component> NO_OBJECTS = ImmutableSet.of();
	...
	public static final Set<Component> PATH_OR_COMPONENTS = ImmutableSet.of( //
			V2State.SCHEMA, //
			V2State.PARAMETER, //
			V2State.RESPONSE, //
	...
	// INLINE_ALL, given that inlining is the only possible treatment of path
	// references
	public static final Option INLINE_PATHS = new Option(INLINE, new Component[] { V2State.PATH, V3State.PATH });
	public static final Option INLINE_DEFINITIONS = new Option(INLINE, V2State.SCHEMA);
	public static final Option INLINE_PARAMETERS = new Option(INLINE,
			new Component[] { V2State.PARAMETER, V3State.PARAMETER });
	public static final Option INLINE_RESPONSES = new Option(INLINE,
			new Component[] { V2State.RESPONSE, V3State.RESPONSE });
	public static final Option INLINE_SCHEMAS = new Option(INLINE, new Component[] { V2State.SCHEMA, V3State.SCHEMA });
	...
	public static final Option RETAIN_PATHS = new Option(RETAIN, new Component[] { V2State.PATH, V3State.PATH });
	public static final Option RETAIN_DEFINITIONS = new Option(RETAIN, V2State.SCHEMA);
	public static final Option RETAIN_PARAMETERS = new Option(RETAIN,
			new Component[] { V2State.PARAMETER, V3State.PARAMETER });
	public static final Option RETAIN_RESPONSES = new Option(RETAIN,
			new Component[] { V2State.RESPONSE, V3State.RESPONSE });
	...
	public static final Option[] DOC_DEFAULT_OPTIONS = new Option[] { //
			new Option(INLINE,
					ImmutableSet.of(V2State.PARAMETER, V2State.RESPONSE, V3State.PARAMETER, V3State.RESPONSE)), //
