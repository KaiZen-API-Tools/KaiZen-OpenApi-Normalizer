...
import static com.reprezen.kaizen.normalizer.V2State.ANON;
import static com.reprezen.kaizen.normalizer.V2State.MODEL;
import static com.reprezen.kaizen.normalizer.V2State.OFFROAD;
import static com.reprezen.kaizen.normalizer.V2State.OPERATION;
import static com.reprezen.kaizen.normalizer.V2State.PARAMETER;
import static com.reprezen.kaizen.normalizer.V2State.PARAMETER_DEF;
import static com.reprezen.kaizen.normalizer.V2State.PATH;
import static com.reprezen.kaizen.normalizer.V2State.RESPONSE;
import static com.reprezen.kaizen.normalizer.V2State.RESPONSE_DEF;
import static com.reprezen.kaizen.normalizer.V2State.SCHEMA;
import static com.reprezen.kaizen.normalizer.V2State.SCHEMA_DEF;
